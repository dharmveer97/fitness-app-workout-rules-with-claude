  ...
  return (
    ...
    >
      <View className='mb-3 flex-row items-center justify-between'>
        <Text className='text-primary text-xl font-bold'>Daily Motivation</Text>
          ...
          <View className='border-primary flex-row items-center justify-between border-t pt-4'>
            <View className='flex-row space-x-2'>
              <TouchableOpacity
                ...
                className='bg-surface-primary rounded-full p-2'
              >
                <Animated.View style={animatedBookmarkStyle}>
                  <Ionicons 
                    name={isBookmarked ? 'bookmark' : 'bookmark-outline'} 
                    size={20} 
                    color={isBookmarked ? gradientColors[gradientIndex][0] : 'rgb(var(--text-secondary))'}
                  />
                </Animated.View>
              </TouchableOpacity>
            ...
            <View className='rounded-full px-3 py-1' style={{ backgroundColor: `${gradientColors[gradientIndex][0]}20` }}>
              <Text className='text-xs font-medium' style={{ color: gradientColors[gradientIndex][0] }}>
