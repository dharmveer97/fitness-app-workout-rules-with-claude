      ...
      <Animated.View style={animatedStyle}>
        <TouchableOpacity
          ...
          className={cn(
            ...
            isActive && 'bg-primary-500 border-2 border-primary-300',
            !isCompleted && !isActive && 'bg-dark-700 border-2 border-dark-600',
  ...
  const renderConnector = (index: number) => {
    ...
    if (orientation === 'vertical') {
      return (
        <View className="w-10 items-center py-1">
          <View className="w-0.5 h-12 bg-dark-700 overflow-hidden">
            <Animated.View
    ...
    return (
      <View className="flex-1 mx-2">
        <View className="h-0.5 bg-dark-700 overflow-hidden">
          <Animated.View
