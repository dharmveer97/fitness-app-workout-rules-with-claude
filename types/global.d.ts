...
type AnimatedStyleProp<T> = import('react-native-reanimated').AnimatedStyleProp<T>;
type AnimatedProps<T extends object> = import('react-native-reanimated').AnimatedProps<T>;
