...
export default function ProfileScreen() {
  ...
  const handleNotificationToggle = (notificationType: keyof typeof notifications, value: boolean) => {
  ...
  const handlePrivacyToggle = (privacyType: keyof typeof privacy, value: boolean) => {
    setPrivacy(prev => ({
      ...prev,
      [privacyType]: value,
    }));
    ...
    <View className="flex-1 bg-[#0A0A0B]">
      ...
      >
        <View className="px-6 py-4">
          ...
          {/* Goals Section */}
          <View className="mb-8">
            <View className="bg-[#18181B] rounded-2xl p-1 border border-gray-800/50">
              <SettingsItem
                icon="target"
                title="Daily Goals"
            ...
            {showGoalsSection && (
              <View className="mt-4">
                <GoalInput
                  ...
                  step={500}
                  color="#10B981"
                  onValueChange={(value) => handleGoalChange('dailySteps', value)}
                  delay={100}
                ...
                <GoalInput
                  ...
                  step={250}
                  color="#06B6D4"
                  onValueChange={(value) => handleGoalChange('dailyWater', value)}
                  delay={200}
                ...
                <GoalInput
                  ...
                  step={100}
                  color="#F97316"
                  onValueChange={(value) => handleGoalChange('dailyCalories', value)}
                  delay={300}
                ...
                <GoalInput
                  ...
                  step={1}
                  color="#EF4444"
                  onValueChange={(value) => handleGoalChange('weeklyWorkouts', value)}
                  delay={400}
          ...
          <View className="mb-8">
            ...
            <View className="space-y-1">
              ...
              <SettingsItem
                ...
                onToggle={(value) => handleNotificationToggle('sleepReminders', value)}
                delay={200}
              />
            </View>
          </View>
          ...
          <View className="mb-8">
            ...
            <View className="space-y-1">
              ...
              <SettingsItem
                ...
                onToggle={(value) => handlePrivacyToggle('shareWorkouts', value)}
                delay={150}
              />
            </View>
          </View>
          ...
          <View className="mb-8">
            ...
            <View className="space-y-1">
              ...
              <SettingsItem
                ...
                value={userProfile.unitSystem === 'metric' ? 'Metric' : 'Imperial'}
                type="value"
                color="#6B7280"
